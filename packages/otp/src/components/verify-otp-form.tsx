    ...
    startTransition(async () => {
      try {
        ...
        if (result.success) {
          ...
          setError(result.error || 'VIRHE: OTP-sähköpostin lähetys epäonnistui.');
        }
      } catch (err) {
        setError('VIRHE: OTP-sähköpostin lähetys epäonnistui.');
        console.error('VIRHE: OTP-sähköpostin lähetys epäonnistui:', err);
      }
    });
  };
