...
import { CaptchaProvider } from '@aihio/auth/captcha/client';
import { I18nProvider } from '@aihio/i18n/provider';
import { MonitoringProvider } from '@aihio/monitoring/components';
import { AppEventsProvider } from '@aihio/shared/events';
...
const CaptchaTokenSetter = dynamic(async () => {
  ...
  const { CaptchaTokenSetter } = await import('@aihio/auth/captcha/client');
