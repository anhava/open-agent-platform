...
import { AuthLayoutShell } from '@aihio/auth/shared';
import { requireUser } from '@aihio/supabase/require-user';
...
import { createTeamAccountsApi } from '@aihio/team-accounts/api';
import { AcceptInvitationContainer } from '@aihio/team-accounts/components';
import { Button } from '@aihio/ui/button';
import { Heading } from '@aihio/ui/heading';
...
async function JoinTeamAccountPage(props: JoinTeamAccountPageProps) {
  ...
  if (account) {
    const { getLogger } = await import('@aihio/shared/logger');
