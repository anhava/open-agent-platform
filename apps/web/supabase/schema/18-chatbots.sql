...
(
    ...
    public_id TEXT UNIQUE NOT NULL DEFAULT substring(uuid_generate_v4()::text from 1 for 12)
);

COMMENT ON COLUMN public.chatbots.public_id IS 'Lyhyt, uniikki ja käyttäjäystävällinen tunniste chatbotin jakamiseen ja upottamiseen.';
